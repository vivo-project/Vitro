...
#
    ...
    $cmd = "";
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_is/ci.xml ";
    ...
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_is/cid.xml ";
    ...
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_is/cids.xml ";
...
# 
#
    mkUnoFile("$g_is/cids.xml","counter","$g_is/invis-unomap.xml");

    initFeedbackFile('Per','P-MIR');
    ...
    $cmd .= " unoMapFile=$g_is/invis-unomap.xml ";
    ...
    print "\nSort results ...\n";
    $cmd = "";
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_rdf/isbyinv.rdf ";
    $cmd .= " $g_xslts/rdfsort.xsl > $g_rdf/sisbyinv.rdf ";

    $r = doit($cmd, $g_exef);
    exit(1) if($r);

    updateFeedbackFile('Per','MIR');
...
#
    ...
    print "\nIdentify impact stmts mentioned in multiple AIIS xmls ...\n";
    $cmd = "";
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_is/cce.xml ";
    ...
    $cmd = "";
    print "\nSort impact stmts by Activity Insight id ...\n";
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_is/cced.xml ";
...
# 
#
    mkUnoFile("$g_is/cceds.xml","counter","$g_is/ceis-unomap.xml");
    ...
    $cmd .= " unoMapFile=$g_is/ceis-unomap.xml ";
    $cmd .= " aiisXmlPath=$g_is_xmls_out aiisPrefix=$g_aiis\_ ";
    $cmd .= " extOrgIn=$g_fb/all-curCEOrgs.xml ";
    $cmd .= " extOrgOut=$g_fb/all-curCEOrgs-1.xml ";
    ...
    print "\nSort results ...\n";
    $cmd = "";
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_rdf/isbyce.rdf ";
...
#
    ...
    print "\nIdentify impact stmts mentioned in multiple AIIS xmls ...\n";
    $cmd = "";
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_is/cfo.xml ";
    ...
    $cmd = "";
    print "\nSort impact stmts by Activity Insight id ...\n";
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_is/cfod.xml ";
...
# 
#
    mkUnoFile("$g_is/cfods.xml","counter","$g_is/fois-unomap.xml");


    initFeedbackFile('Org','O-MFOR');
    ...
    $cmd .= " unoMapFile=$g_is/fois-unomap.xml ";
    $cmd .= " aiisXmlPath=$g_is_xmls_out aiisPrefix=$g_aiis\_ ";
    ...
    print "\nSort results ...\n";
    $cmd = "";
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_rdf/isbyfo.rdf ";
    $cmd .= " $g_xslts/rdfsort.xsl > $g_rdf/sisbyfo.rdf ";

    $r = doit($cmd, $g_exef);
    exit(1) if($r);

    updateFeedbackFile('Org', 'MFOR');
...
#
    ...
    print "\nIdentify impact stmts mentioned in multiple AIIS xmls ...\n";
    $cmd = "";
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_is/cgeo.xml ";
    ...
    $cmd = "";
    print "\nSort impact stmts by Activity Insight id ...\n";
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_is/cgeod.xml ";
...
# 
#
    mkUnoFile("$g_is/cgeods.xml","counter","$g_is/geois-unomap.xml");
    ...
    $cmd .= " unoMapFile=$g_is/geois-unomap.xml ";
    $cmd .= " aiisXmlPath=$g_is_xmls_out aiisPrefix=$g_aiis\_ ";
    $cmd .= " extGeoIn=$g_fb/all-curGeoLocs.xml ";
    $cmd .= " extGeoOut=$g_fb/all-curGeoLocs-1.xml ";
    ...
    print "\nSort results ...\n";
    $cmd = "";
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_rdf/isbygeo.rdf ";
...
#
    ...
    print "\nIdentify impact stmts mentioned in multiple AIIS xmls ...\n";
    $cmd = "";
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_is/cpa.xml ";
    ...
    $cmd = "";
    print "\nSort impact stmts by Activity Insight id ...\n";
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_is/cpad.xml ";
...
# 
#
    mkUnoFile("$g_is/cpads.xml","counter","$g_is/pais-unomap.xml");
    ...
    $cmd .= " unoMapFile=$g_is/pais-unomap.xml ";
    $cmd .= " aiisXmlPath=$g_is_xmls_out aiisPrefix=$g_aiis\_ ";
    $cmd .= " extEmphIn=$g_fb/all-curPriorityAreas.xml ";
    $cmd .= " extEmphOut=$g_fb/all-curPriorityAreas-1.xml ";
    ...
    print "\nSort results ...\n";
    $cmd = "";
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_rdf/isbypa.rdf ";
...
#
    ...
    print "\nIdentify impact stmts mentioned in multiple AIIS xmls ...\n";
    $cmd = "";
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_is/cca.xml ";
    ...
    $cmd = "";
    print "\nSort impact stmts by Activity Insight id ...\n";
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_is/ccad.xml ";
...
# 
#
    mkUnoFile("$g_is/ccads.xml","counter","$g_is/cais-unomap.xml");
    ...
    $cmd .= " unoMapFile=$g_is/cais-unomap.xml ";
    $cmd .= " aiisXmlPath=$g_is_xmls_out aiisPrefix=$g_aiis\_ ";
    $cmd .= " extConAreasIn=$g_fb/all-curConAreas.xml ";
    $cmd .= " extConAreasOut=$g_fb/all-curConAreas-1.xml ";
    ...
    print "\nSort results ...\n";
    $cmd = "";
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_rdf/isbyca.rdf ";
...
#
    ...
    print "\nIdentify impact stmts mentioned in multiple AIIS xmls ...\n";
    $cmd = "";
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_is/cua.xml ";
    ...
    $cmd = "";
    print "\nSort impact stmts by Activity Insight id ...\n";
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_is/cuad.xml ";
...
# 
#
    mkUnoFile("$g_is/cuads.xml","counter","$g_is/uais-unomap.xml");
    ...
    $cmd .= " unoMapFile=$g_is/uais-unomap.xml ";
    $cmd .= " aiisXmlPath=$g_is_xmls_out aiisPrefix=$g_aiis\_ ";
    $cmd .= " extUsdaAreasIn=$g_fb/all-curUsdaAreas.xml ";
    $cmd .= " extUsdaAreasOut=$g_fb/all-curUsdaAreas-1.xml ";
    ...
    print "\nSort results ...\n";
    $cmd = "";
    $cmd .= "java $g_javaopts -jar $g_xslts/saxon9he.jar $g_rdf/isbyua.rdf ";
