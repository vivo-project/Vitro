...
<aigrant:AGENCIES_RECEIVING_SUBMISSIONS xmlns:aigrant='http://vivoweb.org/ontology/activity-insight'>

<xsl:for-each-group select='$docs//dm:Record/dm:CONGRANT/dm:CONGRANT_OTHER_AGENCY' 
...
</aigrant:AGENCIES_RECEIVING_SUBMISSIONS>
