...
<!--xsl:variable name='nid' select='lower-case(@username)'/-->
...
<xsl:if test='not($fps/person[cornell=$nid])'>
<xsl:variable name='x' select=
'$fps/person[fname = FirstName and mname = MiddleName and lname = LastName]'/>
