...
public class JsonContainerSerializationType extends SerializationType {
    ...
    public boolean equals(Object object) {
        ...
        return new EqualsBuilder().append(getName(), compared.getName()).append(getInternalElements(), compared
                .getInternalElements()).isEquals();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder(11, 97).append(getName()).append(getInternalElements()).toHashCode();
    }
}
