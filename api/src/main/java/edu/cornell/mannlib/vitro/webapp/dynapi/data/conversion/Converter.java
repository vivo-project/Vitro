...
public class Converter {
    ...
    private static Set<String> supportedContentTypes = new HashSet<>(Arrays.asList(ContentType.APPLICATION_JSON
            .getMimeType().toString(), ContentType.MULTIPART_FORM_DATA.getMimeType().toString(), ContentType.WILDCARD
    ...
    protected static ContentType getResponseType(String header, ContentType requestType) throws ConversionException {
    ...
    public static void convertToResponse(HttpServletResponse response, Procedure procedure, DataStore dataStore)
            throws ConversionException {
