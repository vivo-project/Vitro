...
public class RDFServiceSparql extends RDFServiceImpl implements RDFService {
     ...
     * 
     * @param readEndpointURI      - URI of the read SPARQL endpoint for the
     *                             knowledge base
     * @param updateEndpointURI    - URI of the update SPARQL endpoint for the
     *                             knowledge base
     * @param defaultWriteGraphURI - URI of the default write graph within the
     *                             knowledge base. this is the graph that will be
     *                             written to when a graph is not explicitly
     *                             specified.
     *
     *                             The default read graph is the union of all graphs
     ...
     * Returns an RDFService for a remote repository
     * 
     * @param readEndpointURI   - URI of the read SPARQL endpoint for the knowledge
     *                          base
     * @param updateEndpointURI - URI of the update SPARQL endpoint for the
     *                          knowledge base
     *
     *                          The default read graph is the union of all graphs in
     *                          the knowledge base
     */
     ...
     * Returns an RDFService for a remote repository
     * 
     * @param endpointURI - URI of the read and update SPARQL endpoint for the
     *                    knowledge base
     *
    ...
    /**
     * Perform a series of additions to and or removals from specified graphs in the
     * RDF store. preConditionSparql will be executed against the union of all the
     * graphs in the knowledge base before any updates are made. If the precondition
     * query returns a non-empty result no updates will be made.
     *
    ...
    /**
     * Performs a SPARQL construct query against the knowledge base. The query may
     * have an embedded graph identifier.
     *
     * @param queryStr     - the SPARQL query to be executed against the RDF store
     * @param resultFormat - type of serialization for RDF result of the SPARQL
     *                     query
     */
    @Override
    ...
    /**
     * Performs a SPARQL describe query against the knowledge base. The query may
     * have an embedded graph identifier.
     *
     * @param queryStr     - the SPARQL query to be executed against the RDF store
     * @param resultFormat - type of serialization for RDF result of the SPARQL
    ...
    /**
     * Performs a SPARQL ASK query against the knowledge base. The query may have an
     * embedded graph identifier.
     *
     * @param queryStr - the SPARQL query to be executed against the RDF store
     *
    ...
    /**
     * Unregister a listener from listening to changes in any graph in the RDF
     * store.
     *
     */
    @Override
...
//  }
    ...
    private List<Statement> sort(List<Statement> stmts) {
        ...
        ConcurrentLinkedQueue<org.apache.jena.rdf.model.Resource> subjQueue = new ConcurrentLinkedQueue<org.apache.jena.rdf.model.Resource>();
