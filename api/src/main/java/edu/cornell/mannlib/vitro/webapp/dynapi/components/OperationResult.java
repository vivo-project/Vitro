...
public class OperationResult {
    ...
    private static final OperationResult INTERNAL_SERVER_ERROR = new OperationResult(
            HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
    private static final OperationResult METHOD_NOT_ALLOWED = new OperationResult(
            HttpServletResponse.SC_METHOD_NOT_ALLOWED);
    private static final OperationResult UNAUTHORIZED = new OperationResult(HttpServletResponse.SC_UNAUTHORIZED);
    ...
    public boolean equals(Object object) {
        ...
        return new EqualsBuilder().append(responseCode, or.responseCode).isEquals();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder(41, 505).append(responseCode).toHashCode();
    }
