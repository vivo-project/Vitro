 ...
 */
public class DataDistributorAccessObject extends AccessObject {
    private final String uri;

    public DataDistributorAccessObject(String uri) {
        this.uri = uri;
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof DataDistributorAccessObject) {
            DataDistributorAccessObject that = (DataDistributorAccessObject) o;
    ...
    public AccessObjectType getType() {
        return AccessObjectType.DATA_DISTRIBUTOR;
    }
