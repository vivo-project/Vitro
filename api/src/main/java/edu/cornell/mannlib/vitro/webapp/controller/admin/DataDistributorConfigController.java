...
public class DataDistributorConfigController extends FreemarkerHttpServlet {
    ...
    protected ResponseValues processRequest(VitroRequest vreq) throws Exception {
        ...
        // If we haven't determined a response, show a list of distributors and
        // graphbuilders
     ...
     *
     * key = property uri value = list of values
     */
    ...
    private ResponseValues makeResponseValues(VitroRequest vreq, Class objectClass, Map<String, Object> bodyMap) {
        ...
        // Pass existing graphbuilders to the UI for any drop downs to select a child
        // graphbuilder
        bodyMap.put("graphbuilders", ddDao.getAllGraphBuilders());
    ...
    private Class findClass(String name) {
        ...
        if (objectClass != null) {
            if (DataDistributor.class.isAssignableFrom(objectClass)
                    || GraphBuilder.class.isAssignableFrom(objectClass)) {
                return objectClass;
            }
        }
                    ...
                    if (value != null) {
                        ...
                        if (!StringUtils.isEmpty(value)) {
                            ...
                            if (String.class.equals(method.getParameterType())) {
                                ...
                                // Not a String, so add a statement for this property with the value as a
                                // resource
                                model.add(subject, model.getProperty(method.getPropertyUri()),
