...
public class IndividualListController extends FreemarkerHttpServlet {
    ...
    /*
     * The call to the attribution in JsonServlet ensures the uniformity of the assigned value
     */
    ...
    protected ResponseValues processRequest(VitroRequest vreq) {
        ...
        try {
            ...
            if (obj == null) { // look for vitroclass id parameter
                ...
                throw new HelpException(
                        "IndividualListController: attribute 'vclass' must be of type " + VClass.class.getName() + ".");
            }
            ...
            if (vclass != null) {
                ...
                IndividualListResults vcResults = getResultsForVClass(vclass.getURI(), page, alpha, vreq);
    ...
    public static IndividualListResults getResultsForVClassIntersections(List<String> classUris, int page, int pageSize,
    ...
    public static IndividualListResults getRandomResultsForVClass(String vclassURI, int page, int pageSize,
            VitroRequest vreq) {
        try {
            List<String> classUris = Collections.singletonList(vclassURI);
            IndividualListQueryResults results = buildAndExecuteRandomVClassQuery(classUris, page, pageSize,
                    vreq.getWebappDaoFactory().getIndividualDao());
    ...
    private static IndividualListResults getResultsForVClassQuery(IndividualListQueryResults results, int page,
            int pageSize, String alpha, VitroRequest vreq) {
    ...
    private static IndividualListQueryResults buildAndExecuteVClassQuery(List<String> vclassURIs, String alpha,
            Locale locale, int page, int pageSize, IndividualDao indDao) throws SearchEngineException {
    ...
    private static IndividualListQueryResults buildAndExecuteRandomVClassQuery(List<String> vclassURIs, int page,
            int pageSize, IndividualDao indDao) throws SearchEngineException {
    ...
    public static List<PageRecord> makePagesList(long size, int pageSize, int selectedPage, VitroRequest vreq) {
        ...
        if (selectedPage < MAX_PAGES && requiredPages > MAX_PAGES) {
            // the selected pages is within the first maxPages, just show the normal pages
            // up to maxPages.
            for (int page = 1; page < requiredPages && page <= MAX_PAGES; page++) {
                records.add(new PageRecord("page=" + page, Integer.toString(page), Integer.toString(page),
                        selectedPage == page));
            }
