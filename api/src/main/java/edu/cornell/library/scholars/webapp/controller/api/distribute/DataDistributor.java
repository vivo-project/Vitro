...
public interface DataDistributor {
     ...
     *
     * @param ddContext provides access to requrest parameters and triple-store
     *                  content.
    ...
    /**
     * Writes to the output stream (does not close it). This output will become the
    ...
    /**
     * The controller could not find a DataDistributor configured for the requested
     * action.
     */
     ...
     *
     * @see DataDistributorContext#isAuthorized(
