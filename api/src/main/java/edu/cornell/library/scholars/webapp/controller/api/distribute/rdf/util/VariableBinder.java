...
public class VariableBinder {
    ...
    public QueryHolder bindValuesToQuery(Set<String> uriBindingNames, Set<String> literalBindingNames,
            QueryHolder query) throws MissingParametersException {
        Objects.requireNonNull(uriBindingNames, "'uriBindingNames' must not be null.");
        Objects.requireNonNull(literalBindingNames, "'literalBindingNames' must not be null.");
        Objects.requireNonNull(query, "'query' must not be null.");
        return bindUriParameters(uriBindingNames, bindLiteralParameters(literalBindingNames, query));
    }
