...
public interface DataDistributorContext {
     ...
     * 
     * Each value is a non-empty array. Null values, or zero-length arrays are not
     * allowed. Arrays may not contain nulls, but may contain empty strings.
     */
    Map<String, String[]> getRequestParameters();

    /**
     * The data structures that provide access to the content of the triple-store.
     * 
     ...
     * accounts, it should execute a check of this nature:
     * 
     * <pre>
     ...
     * </pre>
     * 
     * It is probably best to execute this code in the DataDistributor's init() or
     * writeOutput() methods.
     * 
     * @param actions The activities for which the user must be authorized, or the
     ...
     */
    public static Map<String, List<String>> arraysToLists(Map<String, String[]> arrays) {
     ...
     */
    public static Map<String, String[]> listsToArrays(Map<String, List<String>> lists) {
     ...
     * original.
     */
    public static Map<String, String[]> deepCopyParameters(Map<String, String[]> map) {
