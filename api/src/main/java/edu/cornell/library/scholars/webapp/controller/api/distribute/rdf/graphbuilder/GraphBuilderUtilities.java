...
public class GraphBuilderUtilities {
    private static final Log log = LogFactory.getLog(GraphBuilderUtilities.class);
    ...
    public static class GraphBuilders {
        ...
        public GraphBuilders(DataDistributorContext ddContext, Collection<GraphBuilder> builders) {
        ...
        private Model runBuilder(GraphBuilder builder) throws DataDistributorException {
            return builder.buildGraph(ddContext);
        }
    }

    public static class EnhancedDataDistributionContext implements DataDistributorContext {
        ...
        public EnhancedDataDistributionContext(DataDistributorContext inner) {
            this.inner = inner;
            this.enhancedParameters = arraysToLists(inner.getRequestParameters());
        }

        public EnhancedDataDistributionContext addParameterValue(String key, String value) {
