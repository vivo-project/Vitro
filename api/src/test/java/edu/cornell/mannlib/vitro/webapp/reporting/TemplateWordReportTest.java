...
public class TemplateWordReportTest {
    ...
    private static final String TEMPLATE_PATH = REPORTING_DIR + "/reportTemplate.docx";
    private static final String CONTENT_PATH = REPORTING_DIR + "/content.n3";

    private static final boolean debug = false;

    @Test
    public void testWordReport() throws Exception {
        ...
        TemplateWordReport reportGenerator = new TemplateWordReport();
        ...
        if (debug) {
            File file = new File(REPORTING_DIR + "/report.docx");
