...
public class ConverterResponseContentNegotiationTest {
    ...
    public static Collection<Object[]> parameters() {
        return Arrays.asList(new Object[][] {
            ...
            { WILDCARD.toString(), MULTIPART_FORM_DATA, false, APPLICATION_JSON.toString() },
            { TEXT_HTML.toString()+", " + MULTIPART_FORM_DATA + ";q=0.9", MULTIPART_FORM_DATA, false, MULTIPART_FORM_DATA.toString() },
            { TEXT_HTML.toString()+", " + APPLICATION_JSON + ";q=0.9", MULTIPART_FORM_DATA, false, APPLICATION_JSON.toString() },
            { APPLICATION_JSON.toString()+";q=0.8, " + MULTIPART_FORM_DATA + ";q=0.9", MULTIPART_FORM_DATA, false, MULTIPART_FORM_DATA.toString() },
            { APPLICATION_JSON.toString()+";q=0.001, " + MULTIPART_FORM_DATA + ";q=0.9", MULTIPART_FORM_DATA, false, MULTIPART_FORM_DATA.toString() },
            //0.00001 is too long so it is skipped and default 1 used.
            { APPLICATION_JSON.toString()+";q=0.0001, " + MULTIPART_FORM_DATA + ";q=0.9", MULTIPART_FORM_DATA, false, APPLICATION_JSON.toString() },
        });
    }
}
