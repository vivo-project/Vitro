...
<section id="edit-myProxy" name="proxyProxiesPanel" role="region">
    ...
    <input id="addProfileEditor" type="text" name="proxySelectorAC" class="acSelector" size="35" value="Select an existing last name" role="input" /><span><img class="loading-profileMyAccount hidden" src="${urls.images}/indicatorWhite.gif" /></span>
