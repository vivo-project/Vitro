...
public class BrowseControllerSTGF extends VitroHttpServlet {
    ...
    throws IOException, ServletException {
        try {
            ...
            PageSTGF p = new BrowseGroupPage(portal);
            p.setRequest(vreq);
...
//    }
    ...
    private class BrowseControllerChangeListener extends StatementListener {
        private BrowseControllerSTGF controller = null;
        public BrowseControllerChangeListener(BrowseControllerSTGF controller){
