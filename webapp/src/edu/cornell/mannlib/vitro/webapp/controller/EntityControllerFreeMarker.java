 ...
 *
 */
public class EntityControllerFreeMarker extends VitroHttpServlet {
    private static final Log log = LogFactory.getLog(EntityControllerFreeMarker.class.getName());
