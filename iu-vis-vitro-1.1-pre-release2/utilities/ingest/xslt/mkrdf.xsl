...
<xsl:param name='extantPersonsFileIn' required='yes'/>
<xsl:param name='extantPersonsFileOut' required='yes'/>
...
<!-- xsl:variable name='foafuri' select="concat('http://vivoweb.org/individual/aiic-',$uno)"/ -->
...
<xsl:variable name='foafuri' select="if($knownUri != '') then $knownUri else concat('http://vivoweb.org/individual/aiic-',$uno)"/>
...
<core:authorInAuthorship rdf:resource="{concat('http://vivoweb.org/individual/',$aiid,'-',$rank)}"/>
</rdf:Description>
</xsl:if>
